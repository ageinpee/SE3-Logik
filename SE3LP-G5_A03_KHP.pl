...
schmaelerung(Jahr1, Insgesamt_Erloesdiff) :- findall(Erloesdiff,
                                                      (Jahr2 is Jahr1-1,
...
--> Bedeutet: Durch den Preisnachlass im Vergleich zum Vorjahr wurden insgesamt 3489 Euro mehr eingenommen.
*/
/*========= A2.1 */
